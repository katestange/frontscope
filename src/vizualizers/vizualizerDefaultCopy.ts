import { VizualizerExportModule, VizualizerInterface, VizualizerParamsSchema, VizualizerSettings } from './vizualizerInterface';
...
export class VizualizerKateTest extends VizualizerDefault implements VizualizerInterface{
